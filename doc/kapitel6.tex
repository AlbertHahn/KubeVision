...
Die Speicherung der Passwörter erfolgt in Form eines Hashes (vgl. Quellcode \ref{lst:auth}).
Bei erfolgreichem Login wird ein Cookie mit dem Benutzernamen gesetzt und weitergeleitet in das Homemenü.
...
\begin{lstlisting}[caption={Ausschnit aus auth.py},captionpos=b ,label={lst:auth},language=python]
